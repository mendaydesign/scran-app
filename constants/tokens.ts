 ...
 * Typography font families: Clash Grotesk Bold, Clash Grotesk Semibold, NeueHaasDisplay-Medium.
 */
...
export const FontFamily = {
  ...
  body:            'NeueHaasDisplay-Medium',  // Used for: Body Base, Body Strong, Body Emphasis, Body Link, Body Small, Body Code
} as const;
